...
export default function OfferDrawer({ open, onClose, offerId, onEdit, onDelete, onRefresh }: Props) {
 ...
 <div>
 <h2 className="text-xl font-bold text-slate-900 dark:text-text-primary">Offer Details</h2>
 ...
 <button
 onClick={onClose}
 className="rounded-xl p-2 text-muted dark:text-muted transition hover:bg-slate-100 dark:hover:bg-secondary-surface hover:text-slate-900 dark:hover:text-text-primary"
 >
 <X className="h-5 w-5" />
 </button>
 </div>
 ...
 <User className="h-4 w-4 text-muted dark:text-muted" />
 ...
 <div className="rounded-2xl border border-border dark:border-border bg-slate-50/80 dark:bg-surface p-4">
 ...
 <div className="text-sm font-semibold text-slate-900 dark:text-text-primary mt-2">
 {offer.salary}
 </div>
 </div>
 ...
 <h4 className="text-sm font-semibold text-slate-900 dark:text-text-primary flex items-center gap-2">
 ...
 <label className="text-xs font-medium text-slate-600 dark:text-muted hover:text-slate-800 dark:hover:text-secondary cursor-pointer">
 Replace
 ...
 <div className="rounded-xl border border-dashed border-border dark:border-border p-6 flex flex-col items-center justify-center text-center">
 <div className="rounded-full bg-slate-100 dark:bg-secondary-surface p-3 mb-2">
 <FileText className="h-5 w-5 text-muted dark:text-muted" />
 </div>
 <p className="text-sm text-muted dark:text-muted mb-1">No letter generated yet</p>
 ...
 {/* Notes */}
 <div className="space-y-3">
 <h4 className="text-sm font-semibold text-slate-900 dark:text-text-primary">Notes</h4>
 <div className="rounded-xl border border-border dark:border-border bg-slate-50/80 dark:bg-surface p-4">
 <p className="text-sm text-slate-600 dark:text-secondary whitespace-pre-wrap">
 ...
 <div className="relative border-l border-border dark:border-border ml-3 space-y-6 pb-4">
 <div className="relative pl-6">
 <div className="absolute -left-1.5 top-1.5 h-3 w-3 rounded-full border-2 border-surface bg-primary"></div>
 <p className="text-sm text-slate-900 dark:text-text-primary">Offer Created</p>
 <p className="text-xs text-muted dark:text-muted mt-1">By Admin</p>
 </div>
 ...
 <p className="text-sm text-slate-900 dark:text-text-primary">Offer Sent</p>
 ...
 <p className="text-sm text-slate-900 dark:text-text-primary">Offer Accepted</p>
 ...
 <p className="text-sm text-slate-900 dark:text-text-primary">Offer Rejected</p>
 ...
 {/* Footer / Actions */}
 {offer && (
 <div className="shrink-0 border-t border-border dark:border-border bg-secondary-surface dark:bg-surface/80 p-4 ">
 <div className="grid grid-cols-2 gap-3 mb-3">
 <button 
 onClick={() => { onClose(); onEdit(offer.id); }}
 className="flex items-center justify-center gap-2 rounded-xl border border-border dark:border-border bg-white dark:bg-secondary-surface py-2.5 text-sm font-medium text-slate-700 dark:text-text-primary transition hover:bg-slate-50 dark:hover:bg-secondary-surface"
 >
 <Edit className="h-4 w-4 text-muted dark:text-muted" />
 Edit
 </button>
 <button 
 ...
 <label className="flex flex-1 items-center justify-center gap-2 rounded-xl border border-border dark:border-border bg-slate-50 dark:bg-secondary-surface/50 py-2.5 text-sm font-medium text-slate-700 dark:text-secondary transition hover:bg-slate-100 dark:hover:bg-secondary-surface hover:text-slate-900 dark:hover:text-text-primary cursor-pointer">
