...
export default function ViewOfferModal({ open, onClose, offerId }: Props) {
 ...
 <div>
 <h2 className="text-2xl font-bold text-text-primary">View Offer</h2>
 ...
 {loading ? (
 <div className="text-muted">Loading offer details...</div>
 ) : offer ? (
 <div className="space-y-4">
 <div>
 <label className="text-xs text-muted">Status</label>
 <div className="text-text-primary">{offer.status}</div>
 </div>
 <div>
 <label className="text-xs text-muted">Salary</label>
 <div className="text-text-primary">{offer.salary}</div>
 </div>
 <div>
 <label className="text-xs text-muted">Employment Type</label>
 <div className="text-text-primary">{offer.employment_type}</div>
 </div>
 <div>
 <label className="text-xs text-muted">Joining Date</label>
 <div className="text-text-primary">{offer.joining_date}</div>
 </div>
 <div>
 <label className="text-xs text-muted">Offer Expiry</label>
 <div className="text-text-primary">{offer.offer_expiry}</div>
 </div>
 <div>
 <label className="text-xs text-muted">Notes</label>
 <div className="text-text-primary whitespace-pre-wrap">{offer.notes || "None"}</div>
 </div>
 </div>
 ) : (
 <div className="text-muted">Offer not found.</div>
 )}
 </div>
