...
function AdminLayoutContent({
 ...
 <AdminNavbar />
 <div className="flex-1 flex items-center justify-center p-6 bg-background/20">
 <div className="max-w-md w-full bg-[#0f172a]/80 border border-red-500/20 rounded-2xl p-8 text-center shadow-[0_10px_40px_rgba(0,0,0,0.7)] space-y-6">
 ...
 <h3 className="text-xl font-bold text-text-primary tracking-tight">Access Denied</h3>
 ...
 className="w-full py-2.5 px-4 bg-secondary-surface hover:bg-slate-700 text-sm font-medium text-text-primary border border-border rounded-xl transition-all shadow-lg"
 >
