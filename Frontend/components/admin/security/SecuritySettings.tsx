...
export default function SecuritySettings() {
 ...
 {/* Header */}
 <div className="mb-6">
 <h3 className="text-xl font-semibold text-text-primary">Security Settings</h3>
 <p className="mt-1 text-sm text-muted">Configure authentication and platform security</p>
 </div>
 ...
 <div>
 <h4 className="text-sm font-medium text-text-primary">Multi-Factor Authentication</h4>
 <p className="mt-1 text-sm text-muted">Require a second verification step on login</p>
 </div>
 ...
 <p className="mt-1 text-sm text-muted">Automatically log out inactive users</p>
 </div>
 <select
 ...
 <div className="flex items-center justify-between rounded-xl border border-border bg-surface p-4">
 <div>
 <h4 className="text-sm font-medium text-text-primary">Strong Password Policy</h4>
 <p className="mt-1 text-sm text-muted">Enforce complex password requirements</p>
 </div>
 <label className="relative inline-flex cursor-pointer items-center">
 <input
 type="checkbox"
 ...
 <div className="flex items-center justify-between rounded-xl border border-border bg-surface p-4">
 <div>
 <h4 className="text-sm font-medium text-text-primary">Audit Logging</h4>
 <p className="mt-1 text-sm text-muted">Track user activities and platform operations</p>
 </div>
 <label className="relative inline-flex cursor-pointer items-center">
 <input
 type="checkbox"
