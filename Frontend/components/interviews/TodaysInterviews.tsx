...
export default function TodaysInterviews() {
 ...
 <div
 key={i}
 className="h-16 animate-pulse rounded-2xl bg-secondary-surface"
 />
 ))}
 </div>
 </div>
 ...
 <div
 key={item.id}
 className="rounded-2xl border border-border bg-surface p-4 hover:border-violet-500 transition"
 >
 <div className="flex items-center justify-between">
 <div>
