...
export default function EditInterviewModal({
 ...
 `w-full rounded-2xl border px-4 py-3 text-text-primary outline-none transition ${
 touched && hasError
 ...
 <div>
 <h2 className="text-2xl font-bold text-text-primary">Edit Interview</h2>
 <p className="mt-1 text-sm text-muted">Update interview details</p>
 </div>
 <button onClick={onClose} className="rounded-xl p-2 hover:bg-secondary-surface transition">
 ...
 {/* Date */}
 <div>
 <label className="mb-2 flex items-center gap-1 text-sm text-secondary">
 ...
 {/* Mode */}
 <div>
 <label className="mb-2 block text-sm text-secondary">Mode</label>
 <select
 value={mode}
