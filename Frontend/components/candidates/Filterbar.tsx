...
export function FilterBar({
 ...
 className="appearance-none pl-3 pr-8 py-1.5 text-sm border border-border rounded-xl bg-surface text-text-primary focus-ring cursor-pointer"
 >
 {EXP_OPTIONS.map((o) => (
 ...
 <button
 onClick={onClearAll}
 className="inline-flex items-center gap-1 px-3 py-1.5 text-sm text-muted hover:text-slate-700 hover:bg-slate-100 rounded-lg transition-colors"
 >
 ...
 <span className="text-xs font-medium text-muted self-center mr-1">Skills:</span>
