 ...
 <div className="space-y-6 p-6">
   ...
   <div className="rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-slate-50 dark:bg-[#161C2C] p-5">
     ...
     <div className="mt-4 flex flex-wrap gap-3">
       {position.skills.map((skill, index) => (
         <span
           key={index}
           className="rounded-full bg-indigo-50 dark:bg-indigo-500/10 px-4 py-2 text-sm font-semibold text-indigo-600 dark:text-indigo-400"
         >
           {skill}
         </span>
       ))}
   ...
   <div className="rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-slate-50 dark:bg-[#161C2C] p-5">
     ...
     <div className="mt-5 space-y-4">
       ...
       <button
         onClick={() =>
           router.push(`/pipeline?positionId=${position.id}`)
         }
